...
!function(jQuery, undefined) {
    ...
    jQuery.fn.extend({
        revolution: function(i) {
            ...
            this.each(function() {
                ...
                i.jsFileLocation = i.jsFileLocation || getScriptLocation("error-404.html"),
    ...
    var _ISM = _R.is_mobile()
      ...
      , getScriptLocation = function(e) {
        ...
        t = (t = (t = t.replace("error-404.html", "")).replace("error-404.html", "")).split("?")[0]
    }
      ...
      , abstorel = function(e, i) {
        var t = e.split("https://industry.dexignzone.com/")
          , a = i.split("https://industry.dexignzone.com/");
        t.pop();
        for (var n = 0; n < a.length; n++)
            "." != a[n] && (".." == a[n] ? t.pop() : t.push(a[n]));
        return t.join("https://industry.dexignzone.com/")
    }
            ...
            if (e.data("loaded") === undefined && t !== undefined && t.progress && t.progress.match(/loaded/g)) {
                ...
                "img" == t.type)
                    if (e.hasClass("defaultimg"))
                        _R.isIE(8) ? defimg.attr("src", t.src) : -1 == t.src.indexOf("error-404.html") && -1 == t.src.indexOf("error-404.html") || e.data("bgcolor") === undefined ? e.css({
